...
public:
    ...
    // ?? Exit plan (�6) � structs needed by SerialEntry ??????
    ...
    static SerialPlan generateSerialPlan(const SerialParams& sp)
    {
        ...
        // Price range.
        // Default: [0, currentPrice] � the full discount spectrum.
        // autoRange: [price � (1 - 3�EO), price] � clusters entries
