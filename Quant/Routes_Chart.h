...
inline void registerChartRoutes(httplib::Server& svr, AppContext& ctx)
{
    ...
    svr.Get("/chart", [&](const httplib::Request&, httplib::Response& res) {
        ...
        pg << "var sTimer=null;\n"
              ...
              "'s_symCount','s_coeffK','s_feeSpread','s_deltaTime','s_surplus','s_maxRisk','s_minRisk','s_isShort','s_fundMode','s_genSL','s_rangeAbove','s_rangeBelow','s_dtCount'];\n"
              "ids.forEach(function(id){$(id).addEventListener('input',function(){\n"
        ...
        pg << "function eoColor(eo,mn,mx){\n"
              ...
              "return v.toFixed(4);}\n";
        // drawH � renders single tile or small-multiples trellis
        pg << "function drawH(){\n"
        ...
        // chain execution — live multi-cycle preview + execution tracking
